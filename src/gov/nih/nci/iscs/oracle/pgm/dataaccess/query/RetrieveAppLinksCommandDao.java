...
public class RetrieveAppLinksCommandDao extends AccessCommandDao implements  RetrieveAppLinksCommand {
   /**
    ...
    * Class constructor
    */
    public RetrieveAppLinksCommandDao() {}
    ...
    public QueryPage execute() {
	   ...
	   QueryPage  mLinksQueryPage = null;
       ...
       try {
           ...
           mLinksQueryPage = new QueryPage(mCriteria, ApplicationConstants.ALL_PAGES, 1);
    ...
    private Criteria buildCriteria(Session aSession) throws CommandDaoException {
        ...
        try{
			...
			throw new CommandDaoException("Unable to create mGwbLinksT class " + e.toString());
	    } catch (Exception e) {
