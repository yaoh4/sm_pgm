...
public class ReferalServiceImpl extends BaseServiceImpl implements GrantSearchService {
    ...
    private Map mapReferralSearchResults(List aNciPdReferralList, PaginationObject aPaginationObject) throws Exception{
		...
		while (mIterator.hasNext() ) {
			...
			if((mNciPdReferral.getDualPocLastName() != null ) &&
			   (mNciPdReferral.getDualPocFirstName() != null ) ) {
				...
				mReferralSearchResultObject.setDualPoc(ApplicationConstants.EMPTY_STRING );
                        ...
                        if(mNciPdReferral.getNihGuideAddr() != null ) {
                                mReferralSearchResultObject.setNihGuideAddrUrl(mNciPdReferral.getNihGuideAddr());
                        } else {
                                mReferralSearchResultObject.setNihGuideAddrUrl(ApplicationConstants.EMPTY_STRING );
                        } 
            ...
            if(mNciPdReferral.getReferralComments() != null )  {
                mReferralSearchResultObject.setReferralComments(mNciPdReferral.getReferralComments());
            } else {
                mReferralSearchResultObject.setReferralComments(ApplicationConstants.EMPTY_STRING );
            }
