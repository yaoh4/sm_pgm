...
public class FormatProgramDirectorSelectTagInactive extends TagSupport {
	...
	private List getPDListForCancerActivity(String cancerActivity) {
		...
		List mList = mProgamDirectorServiceImpl.getPDForTransfer(cancerActivity, true, false);
		return mList;
	}
