...
public class RetrieveGrantsForPDAForm extends RetrieveGrantsForm implements PDAQueryObject {
	...
	private String pdId;
	private String pdId2; // Identifier for selected inactive PD
	...
	public RetrieveGrantsForPDAForm() {
		...
		pdId2 = ApplicationConstants.EMPTY_STRING;
	...
	public String getPdId2() {
		return pdId2;
	}

	public void setPdId2(String pdId2) {
		this.pdId2 = pdId2;
	}
