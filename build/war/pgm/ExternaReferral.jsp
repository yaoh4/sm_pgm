...
<html>
<head>
    <title>External Search Screen</title>
...
<html:form action="externalReferralSearch.do" method="POST" >
<html:hidden property="requestAction" />
<html:hidden property="piLastName" value="d" />
<html:hidden property="grantsFromCriteria" value="<%=ApplicationConstants.MY_CANCER_ACTIVITIES_VALUE%>"/>
...
<table border="0" cellspacing="0" cellpadding="0" width="800" align="center">
  ...
  <tr>
      <td width="20" align="right"><b> External Search </B></td>
      <td><html:submit onclick="setAction('extSearch', 'default');" property="action" value="Search"/></td>
