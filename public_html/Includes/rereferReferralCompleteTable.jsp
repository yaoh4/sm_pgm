           ...
           <noscript>
             <table summary="Grants Table" cellpadding="1" cellspacing="1" width="100%">
              ...
              <tr> 
                  ...
                  <td headers="header02" width="20%" class=listCellHead>PI Name</td>
                  <td headers="header03" width="20%" class=listCellHead>Institution</td>
                  <td headers="header04" width="20%" class=listCellHead>New POC</td>
                  <td headers="header05" width="20%" class=listCellHead>Refer to Other Program Results</td>
              </tr>
              <%
                ...
                while (mIterator.hasNext()) {
      	       ...
      	       %>
      	          ...
      	          <tr> 
                        ...
                        <td headers="header01" width="3%" class=listCell><%=actionObj.getCancerActivity() %>&nbsp;</td>
                        <td headers="header02" width="20%" class=listCell><%=obj.getPiLastName() %>&nbsp;</td>
                        <td headers="header03" width="20%" class=listCell><%=obj.getInstName() %>&nbsp;</td>
                        <td headers="header04" width="20%" class=listCell><%=actionObj.getRereferPOC() %>&nbsp;</td>
                        <td headers="header05" width="20%" class=listCell5>
