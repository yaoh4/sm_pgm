              ...
              <%
                ...
                while (mIterator.hasNext()) {
      	       ...
      	       %>
      	          ...
      	          <tr> 
                        <td headers="header00" width="20%" class=listCell><%=obj.getGrantNumber() %>&nbsp;</td>
                        <td headers="header01" width="3%" class=listCell><%=obj.getCancerActivity() %>&nbsp;</td>
                        <td headers="header02" width="17%" class=listCell><%=obj.getPiLastName() %>&nbsp;</td>
                        <td headers="header03" width="20%" class=listCell><%=obj.getInstName() %>&nbsp;</td>
                        <td headers="header04" width="20%" class=listCell><%=actionObj.getProgramDirector() %>&nbsp;</td>
