          ...
          <td valign="top" colspan="5">
           ...
           <noscript>
             <table summary="Grants Table" cellpadding="1" cellspacing="1" width="100%">
              ...
              <tr> 
                  <td headers="header00" width="15%" class=listCellHead>Grant Number</td>
                  <td headers="header01" width="25%" class=listCellHead>PI Name</td>
                  <td headers="header02" width="20%" class=listCellHead>Institution</td>
                  <td headers="header03" width="4%" class=listCellHead>CA</td>
                  <td headers="header04" width="20%" class=listCellHead>Current POC</td>
                  <td headers="header05" width="25%" class=listCellHead>Release Results</td>
              </tr>
              <%
                ...
                while (mIterator.hasNext()) {
                   ...
                   index = (Integer) mReferralActionMapEntry.getKey();
      	           ReferralActionObject actionObj = (ReferralActionObject) mReferralActionMapEntry.getValue();
      	           ReferralSearchResultObject obj = (ReferralSearchResultObject) referralQueryResults.get(index.intValue()); 
      	       %>

      	          <tr> 
                        <td headers="header00" width="17%" class=listCell><%=obj.getGrantNumber() %>&nbsp;</td>
                        <td headers="header01" width="25%" class=listCell><%=obj.getPiLastName() %>&nbsp;</td>
                        <td headers="header02" width="20%" class=listCell><%=obj.getInstName() %>&nbsp;</td>
                        <td headers="header03" width="4%" class=listCell><%=actionObj.getCancerActivity() %>&nbsp;</td>
                        <td headers="header04" width="20%" class=listCell><%=actionObj.getRereferPOC() %>&nbsp;</td>
                        <td headers="header05" width="25%" class=listCell5>
