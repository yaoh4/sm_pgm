<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
  ...
  <%@ page import="gov.nih.nci.iscs.oracle.pgm.forms.RereferReferralForm" %>

<html>
<head>
    <title>Referral Refer To Other Program Results</title>
...
<html:form action="AcceptReferral.do" method="POST" >
...
<table border="0" cellspacing="0" cellpadding="0" width="800">
  ...
  <tr>
      <td width="600" align="left"><H3>Referral Refer To Other Program Results </H3></td>
  </tr>
  <tr>
   ...
   <tr>
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <!--Include the drop down to select additional Creiteria -->
       <%@include file="Includes/rereferReferralCompleteTable.jsp"%>
     </table>
    </td>
  </tr>
</table>
