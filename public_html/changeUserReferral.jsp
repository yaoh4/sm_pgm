...
<body bgcolor="#FFFFFF" leftmargin="10" topmargin="10" marginwidth="10"
  ...
  <%@ include file="Includes/PgmHeader.jsp"%>
   <div id="content" style="width: 1000px;">
	...
	<li class="linksHeader"><a href="cancelUserReferral.do">Return to Home Page</a></li>
	<li class="linksHeader last"><a href="restoreUserReferral.do">Restore To the User Login</a></li>
	</ul>
	<div id="box2">
   ...
   <html:messages message="true" id="message" property="validation" header="validation.header" footer="validation.footer">
		...
		<html:form action="/SearchUsersReferral">
		 <html:errors/>
...
<html:form action="/SelectUserReferral">
