...
<html>
<head>
    <title>Referral Release Dual Results</title>
...
<table border="0" cellspacing="0" cellpadding="0" width="800">
  ...
  <tr>
      <td width="600" align="left"><H3> Referral Release Dual Results</H3></td>
  </tr>
  <tr>
   ...
   <tr>
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <!--Include the drop down to select additional Creiteria -->
       <%@include file="Includes/releaseReferralCompleteTable.jsp"%>
     </table>
    </td>
  </tr>
</table>
